...
-- query country with the smallest (min) population in Southern Europe from the 'country' table in the 'homework' database
-- step 1
SELECT MIN(population) FROM country WHERE region = 'Southern Europe'
-- step 2
SELECT * FROM country WHERE population = 1000 and region = 'Southern Europe'
